...
# ── Waist: waist_yaw (leg big armature, URDF effort=60) ──
...
# ── Head: head_yaw, head_pitch (AI estimated params, not real) ──
ARMATURE_HEAD = 0.003
EFFORT_HEAD = 20.0
...
if __name__ == "__main__":
  ...
  for label, cfg, arm, eff, vel in [
    ...
    ("Waist     ", CASBOT_WAIST_ACTUATOR, ARMATURE_LEG_BIG, 60.0, VELOCITY_LEG_BIG),
    ("Head (AI) ", CASBOT_HEAD_ACTUATOR, ARMATURE_HEAD, EFFORT_HEAD, 9.3),
  ]:
