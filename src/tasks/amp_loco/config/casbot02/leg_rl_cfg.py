...
def casbot02_leg_amp_ppo_runner_cfg():
  ...
  # Dual-AMP: separate walk and squat motion directories
  cfg.amp_walk_motion_files = os.path.normpath(
    os.path.join(_MOTION_DATA_DIR, "WalkandRun_TurnBoost_v1")
  )
  cfg.amp_squat_motion_files = os.path.normpath(
    os.path.join(_MOTION_DATA_DIR, "Squat")
  )
