"""RL configuration for CASBOT02 leg-only AMP locomotion task."""
...
def casbot02_leg_amp_ppo_runner_cfg():
  """Create RL runner configuration for CASBOT02 leg-only AMP locomotion task."""
  ...
  cfg.min_normalized_std = [0.05] * 13
