...
from policy.mjamp.MJAMP import MJAMP
...
class FSM:
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput, remote_controller=None):
        ...
        self.mjamp_policy = MJAMP(state_cmd, policy_output, remote_controller)
    ...
    def get_next_policy(self, policy_name:FSMStateName):
        ...
        elif((policy_name == FSMStateName.MJAMP)):
            self.cur_policy = self.mjamp_policy
        else:
            pass
