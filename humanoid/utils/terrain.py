...
class HumanoidTerrain(Terrain):
    ...
    def make_terrain(self, choice, difficulty):
        terrain = terrain_utils.SubTerrain(   "terrain",
                                ...
                                vertical_scale=self.cfg.vertical_scale,
                                horizontal_scale=self.cfg.horizontal_scale)
        discrete_obstacles_height = difficulty * 0.08 #0.16
        r_height = difficulty * 0.14 #0.14
        h_slope = difficulty * 0.26 #0.26
        if choice < self.proportions[0]:
            pass
        elif choice < self.proportions[1]:
            num_rectangles = 20
            ...
            terrain_utils.pyramid_sloped_terrain(terrain, slope=h_slope, platform_size=1)
        elif choice < self.proportions[4]:
            terrain_utils.pyramid_sloped_terrain(terrain, slope=-h_slope, platform_size=1)
        elif choice < self.proportions[5]:
