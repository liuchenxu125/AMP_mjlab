...
class L1Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        terminate_after_contacts_on = ['base_link', "link_8"]
    ...
    class terrain(LeggedRobotCfg.terrain):
        ...
        terrain_proportions = [0.0, 0.25, 0.25, 0.25, 0.25, 0.0, 0.0]
        restitution = 0.
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {'joint_5': 50, 'joint_6': 50, 'joint_7': 70,
                     'joint_8': 70, 'joint_9': 40, 'joint_91': 40}
        damping = {'joint_5': 5.0, 'joint_6': 5.0, 'joint_7': 7.0, 
                   'joint_8': 7.0, 'joint_9': 2.0, 'joint_91': 2.0}
    ...
    # class rewards:
    #     base_height_target = 1.0 #0.985#0.827
    #     min_dist = 0.15
    #     max_dist = 0.8
    #     # put some settings here for LLM parameter tuning
    #     arm_scale = 0.15
    #     target_joint_pos_scale = 0.26    # rad ?
    #     target_feet_height = 0.11       # m  ?
    #     cycle_time = 1.0                # sec ??
    ...
    #         joint_pos = 2.8
    #         feet_clearance = 1.6
    #         feet_contact_number = 0.0 #1.4
    #         # gait
    #         feet_air_time = 0.0 #1.5
    #         foot_slip = -0.1
    #         feet_contact_velocity = -0.4
    #         feet_distance = 0.2
    #         knee_distance = 0.2
    #         # contact 
...
class L1CfgPPO(LeggedRobotCfgPPO):
    seed = 5
