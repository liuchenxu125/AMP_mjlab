...
class L13dofCfg(LeggedRobotCfg):
    """
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/HL/urdf/L13dof.urdf'

        name = "L13dof"
        foot_name = "link_91"
        knee_name = "link_8"

        terminate_after_contacts_on = ['base_link', "link_8", "link_1", "link_2", "link_4"]
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {'_joint_1': 30, '_joint_2': 30, '_joint_4': 30,
                     '_joint_5': 70, '_joint_6': 70, '_joint_7': 90,
                     '_joint_8': 90, '_joint_9': 50, '_joint_91': 50}
        damping = {'_joint_1': 2.0, '_joint_2': 2.0, '_joint_4': 2.0,
                   '_joint_5': 7.0, '_joint_6': 7.0, '_joint_7': 9.0, 
                   '_joint_8': 9.0, '_joint_9': 1.0, '_joint_91': 1.0}
    ...
    # class rewards:
    #     base_height_target = 0.985#0.827
    #     min_dist = 0.15
    #     max_dist = 0.8
    #     # put some settings here for LLM parameter tuning
    #     arm_scale = 0.15
    #     target_joint_pos_scale = 0.26    # rad ?
    #     target_feet_height = 0.14       # m  ?
    #     cycle_time = 0.8                # sec ??
    ...
    class rewards:
        ...
        class scales:
            ...
            feet_contact_number = 1.4
            # gait
            feet_air_time = 0.0#1.5
            foot_slip = 0.0#-0.1
            feet_distance = 0.0#0.2
            knee_distance = 0.0#0.2
            # contact 
            feet_contact_forces = 0.0#-0.1
            # vel tracking
            tracking_lin_vel = 1.4
            tracking_ang_vel = 1.1
            vel_mismatch_exp = 0.0#0.5  # lin_z; ang x,y
            low_speed = 0.0#0.2
            track_vel_hard = 0.0#0.5
            # stand_still = 5
            # base pos
            default_joint_pos = 0.0#0.8
            orientation = 0.5
...
class L13dofCfgPPO(LeggedRobotCfgPPO):
    seed = 5
