...
class LeggedRobotCfg(BaseConfig):
    ...
    class domain_rand:
        ...
        add_obs_lag = False
        randomize_obs_motor_lag_timesteps = False
        randomize_obs_motor_lag_timesteps_perstep = False
        obs_motor_lag_timesteps_range = [2, 10]
        ...
        randomize_obs_imu_lag_timesteps = False
        randomize_obs_imu_lag_timesteps_perstep = False
        obs_imu_lag_timesteps_range = [1, 2]
